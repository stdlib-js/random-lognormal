...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a lognormal distribution.
	*
	...
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>>( shape: Shape, mu: number | T, sigma: number | U, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from a lognormal distribution.
	*
	* @param mu - location parameter
	* @param sigma - scale parameter
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( mu: number | T, sigma: number | U, out: V ): V;
}
...
interface Random extends PRNG {
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a lognormal distribution.
	*
	* @param options - function options
